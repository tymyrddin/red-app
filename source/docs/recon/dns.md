...
[OWASP Zed Attack Proxy (ZAP)](red-iac:docs/lab/zap) has a built-in web spider, and [Burp Suite](red-iac:docs/lab/burp) has an equivalent tool called the crawler.
